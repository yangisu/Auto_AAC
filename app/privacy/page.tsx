  ...
  return (
    <main className="policy-page">
      <article className="policy-card">
        ...
        <section>
          <h2>2. 처리하는 데이터와 이용 목적</h2>
          <p>
            비식별 학생 학습 특성, 과학 수업 텍스트, 교사의 수정 지시, 생성 과정의
            프롬프트와 결과를 처리합니다. 이 데이터는 교사가 검토할 AAC 카드 초안
            생성 등 서비스 제공, 보안 유지, 제공업체의 악용 모니터링을 위해 처리합니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            의료번호 등 불필요한 의료 식별정보를 입력하지 마세요. 이 서비스의 의도된
            사용자는 교사이며 학생의 직접 사용은 금지됩니다. 교사는 학생에게 입력
            화면이나 접근 수단을 제공하지 마세요. 식별 가능한 아동 데이터의 입력은
            금지됩니다.
          </p>
        </section>
